...
- GREEN: pending local commit `feat(codex): implement usage core runtime` — production implementation, package metadata, docs, and SDD evidence.
...
| `pnpm build && pnpm smoke:consumer` | exit 0 |
