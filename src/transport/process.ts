...
export function createSafeProcessTransport(deps: ProcessTransportDependencies = {}): SafeProcessTransport {
  ...
  return { async run(request) {
    ...
    return new Promise((resolve) => {
      let output = ""; let outputBytes = 0; let settled = false; let exceeded = false; let terminated = false; let timer: ReturnType<typeof setTimeout> | undefined; let child: SpawnedProcess | undefined;
