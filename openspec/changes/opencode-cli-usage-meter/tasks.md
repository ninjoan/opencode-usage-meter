...
- [x] 3.8 RED/GREEN: pin `node-pty@1.1.0`, authorize only its native build, preserve the consumer `--ignore-scripts` boundary, and wire Ubuntu/macOS native PTY smoke for a new review target.
