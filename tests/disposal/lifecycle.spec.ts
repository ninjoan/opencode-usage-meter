...
describe("usage meter lifecycle", () => {
  it("registers through the public slot API, removes five subscriptions, and aborts an active probe exactly once", async () => {
    ...
    expect(fake.unsubscribes).toHaveLength(5);
